...
Ingesta: lectura de datos desde Google Sheets vía API (gspread)
Preprocesamiento:
...
Modelamiento: entrenamiento de un modelo Random Forest independiente por tipo de suelo
Evaluación: R² y RMSE sobre datos de entrenamiento
Output: predicciones escritas de vuelta a Google Sheets + fórmulas exportadas por tipo de suelo

Resultados del modelo
Tipo de sueloR²RMSEArenoso0.89314.20Franco0.87364.07Arcilloso0.89823.35
